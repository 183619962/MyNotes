...
//	}
	...
	public static void main(String[] args) throws Exception
	{
		...
		String datagram = new StringBuffer()
				// 交易金额
				.append("00000001")
				// 交易类型标识
				.append("06")
...
//		byte[] b = new byte[16];
//		b = ByteUtil.hexStr2Byte(a);
//		printHexString("加密前数据: ", b);
//		//密钥
//		String c = "18D2C6FFE29FFE53D7C41A8F8E819DDE";
//		byte[] d = new byte[24];
//		// 密钥位数不足24位，再从头开始，补足24位
//		d = ByteUtil.hexStr2Byte(c + c.substring(0, 16));
//		printHexString("密钥: ", d);
//
//		// DES加密
//		// byte[] encoded = encryptMode(keyBytes, szSrc);
//		byte[] encoded = encryptMode(d, b);
//		//获取过程密钥
//		String hint = printHexString("加密后的数据: ", encoded).substring(0,16);
//		System.out.println(hint);
//		String MAC1 = PBOC_DES_MAC(hint, "0000000000000000", "1111111111111111", HEX).substring(0,8);
//		System.out.println("MAC：" + MAC1);
		
		Des ss = new Des();
		//获取过程密钥
		String ccc = ss.getHintKey("1111111111111111", "18D2C6FFE29FFE53D7C41A8F8E819DDE");
		String macTest = PBOC_DES_MAC(ccc, "0000000000000000", "1111111111111111", HEX).substring(0,8);
		System.out.println("MAC1：" + macTest);
		
//		System.out.println(PBOC_3DES_MAC("11223344556677881122334455667788", "0000000000000000", datagram, HEX).substring(0,8));
//		System.out.println();
//		System.out.println(PBOC_3DES_MAC("31313232323234343434373737373838", "0000000000000000", "0612B554FFEFFCFB", HEX));
	}
	 ...
	 * @throws:
	 */
	public String getHintKey(String data,String key)
	{
		//加密数据
//		String a = "1111111111111111";
		byte[] b = new byte[16];
		b = ByteUtil.hexStr2Byte(data);
		printHexString("加密前数据: ", b);
		//密钥
//		String c = "18D2C6FFE29FFE53D7C41A8F8E819DDE";
		byte[] d = new byte[24];
		// 密钥位数不足24位，再从头开始，补足24位
		d = ByteUtil.hexStr2Byte(key + key.substring(0, 16));
		printHexString("密钥: ", d);
		// DES加密
		byte[] encoded = encryptMode(d, b);
		//获取过程密钥
		String hintKey = printHexString("加密后的数据: ", encoded).substring(0,16);
		return hintKey;
	}
	 ...
	 * @throws:
	 */
	public String getMAC(Map<String,String> map,String hintKey)
	{
		//拼装数据
		String datagram = new StringBuffer()
				// 交易金额
//				.append("00000001")
				.append(map.get("PAY_MONEY"))
				// 交易类型标识   06消费  02充值
//				.append("06")
				.append(map.get("PAY_TYPE"))
				// 终端机编号
//				.append("000000000001")
				.append(map.get("POS_NO"))
				// 交易日期
//				.append("20141126")
				.append(map.get("PAY_DATE"))
				// 交易时间
//				.append("175111")
				.append(map.get("PAY_TIME"))
				// 转化为字符串
				.toString()
				// 返回字符串对象的规范化表示形式
				.intern();
		...
		//初始向量
		String initData  = "0000000000000000";
		String mac = PBOC_DES_MAC(hintKey, initData, datagram, HEX).substring(0, 8);
		return mac;
	}
